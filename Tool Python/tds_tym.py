...
def nhan(api):
    nhan=ss.get(f'https://traodoisub.com/api/coin/?type=TIKTOK_LIKEW&id=TIKTOK_LIKE_API&access_token={api}').json()
    print("\033[33;1m▪\033[32;1m▪\033[31;1m▪\033[36;1m▪"*15)
    if "success" in nhan:
...
while True:
    for cookie in list:
        ...
        get_cmt=ss.get(f"https://traodoisub.com/api/?fields=tiktok_like&access_token={api}",headers=head).json()
        print(get_cmt)
        ...
        if get_cmt['data']!=[]:
            ...
            for x in get_cmt['data']:
                ...
                duyet=ss.get(f'https://traodoisub.com/api/coin/?type=TIKTOK_LIKE_CACHE&id={idjob}&access_token={api}').json()

                print(f"\033[37;1m[\033[32;1m{h}\033[37;1m][\033[32;1m{time}\033[37;1m][\033[32;1mSUCCESS\033[37;1m][\033[32;1mFOLLOW\033[37;1m][\033[32;1m{id}\033[37;1m][\033[32;1m{duyet['cache']}\033[37;1m]")
