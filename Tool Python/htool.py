...
def main_share():
    clear()
    logo()
    input_file = open(input("\033[1;32mNhập File Chứa Cookie Fb: \033[1;97m")).read().split('\n')
    id_share = input("\033[1;32mNhập ID Bài Viết: \033[1;97m")
    total_share = int(input("\033[1;32mNhập Số Lượt Share: \033[1;97m"))
    delay = int(input("\033[1;32mNhập Delay: \033[1;97m"))
    ...
    while True:
        for tach in all:
            ...
            threa.start()
            threa.join()
            print(f"\033[37;1m[\033[32;1m{stt}\033[37;1m][\033[32;1mSUCCESS\033[37;1m][\033[32;1m{id_share}\033[37;1m]")
        time.sleep(delay)
        if stt > total_share:
            break
    gome_token.clear()
