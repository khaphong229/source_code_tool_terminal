...
$giai=file_get_contents("http://fireender.tk/captcha_v2.php?site_key=6LeGw7IZAAAAAECJDwOUXcriH8HNN7_rkJRZYF8a&web=https://traodoisub.com/view/".$view."&key=atm-tool-vip");
print_r($giai);
echo "\n\n";
